...
def build_transform(cfg, is_train=False, is_expend=False, choices=None):
    ...
    if is_train:
        ...
        return _build_transform_expend(cfg, choices, target_size, normalize)
    else:
...
def _build_transform_expend(cfg, choices, target_size, normalize):
    print("Building transform_expend")
    tfm_test = []
