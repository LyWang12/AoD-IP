...
class SimpleTrainer(TrainerBase):
    ...
    def build_data_loader(self):
        ...
        self.train_loader_e = dm.train_loader_e
        self.test_loader_x = dm.test_loader_x



        self.add_test_loader_1 = dm.add_test_loader_1
        self.add_test_loader_2 = dm.add_test_loader_2
        self.add_test_loader_3 = dm.add_test_loader_3
        self.add_test_loader_4 = dm.add_test_loader_4
    ...
    def model_inference(self, input, domain, mode):
        return self.model(s_image=input, domain=domain, mode=mode)
